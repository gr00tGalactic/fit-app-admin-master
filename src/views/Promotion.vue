<template>
  <div class="page">
    ...
    <div class="page-content">
      <AppStickyHeader>
        <Header>
          <template v-slot:title> ПРОДВИЖЕНИЕ </template>
          <template v-slot:tabs>
            <FilterTabs :tabs="headerTabs" @input="onTabClick" name="header" />
          </template>
        </Header>
              ...
              <tr>
                ...
                <th>
                  <label class="custom-checkbox custom-checkbox--7">
                    ...
                    <span class="custom-checkbox__checkmark"></span>
                    Кол-во покупок курсов
                  </label>
                </th>
                <th>
                  <label class="custom-checkbox custom-checkbox--8">
                    <input type="checkbox" :value="8" v-model="lines" />
                    <span class="custom-checkbox__checkmark"></span>
                    Кол-во покупок подписки
                  </label>
                </th>
              </tr>
            </thead>
    ...
    return {
      ...
      initialDatasets: [
        ...
        },
        {
          ...
          data: this.generateArr(),
          borderColor: "#DE639A",
          pointBackgroundColor: "#DE639A",
          pointBorderColor: "#DE639A",
          fill: false,
          borderWidth: 2,
          // hidden: true,
        },
